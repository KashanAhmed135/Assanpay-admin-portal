            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="grid gap-1.5">
                ...
                <select
                  ...
                  defaultValue={editingMerchant ? editingMerchant.settlement_type : 'Daily'}
                  required
                >
              ...
              <div className="grid gap-1.5">
                ...
                <select
                  ...
                  defaultValue={editingMerchant ? editingMerchant.commission_mode : 'Percentage'}
                  required
                >
              ...
              <div className="grid gap-1.5">
                <label className="text-sm text-[#a9b7d4]/90">Commission Value *</label>
                <input
                  className="h-11 px-3 rounded-xl border border-white/10 bg-black/20 outline-none focus:ring-2 focus:ring-[#5aa7ff]"
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="grid gap-1.5">
                ...
                <select
                  className="h-11 px-3 rounded-xl border border-white/10 bg-black/20 text-[#eaf1ff] outline-none focus:ring-2 focus:ring-[#5aa7ff]"
                  name="status"
                  defaultValue={editingMerchant ? editingMerchant.status : 'active'}
                >
